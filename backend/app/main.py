...
from app.core.middleware import get_rate_limit_exceeded_handler, add_security_headers
...
if settings.RATE_LIMIT_ENABLED:
    get_rate_limit_exceeded_handler(app)
...
async def health_check():
    ...
    Returns:
        dict: Application health status with dependency checks
